...
//! - [Static rigid bodies](`crate::physics::static_mesh`) — per-chunk collision mesh generation from
//!   marked particles
//! - [Particle colliders](`crate::physics::particle_colliders`) — make Avian colliders occupy
//!   particle-grid cells so falling sand movement routes around them
...
//! - [Marking Avian colliders as particle blockers](`ParticleCollider`)
//! - [Configuring collider resting behavior](`ParticleColliderRestingOptions`)
...
//!
//! ## [Grid geometry utilities](`crate::utils::geometry`)
//!
//! - [Grouping connected cells](`crate::utils::connected_components`)
//! - [Finding perimeter cells](`crate::utils::perimeter_positions`)
//! - [Simplifying polylines](`crate::utils::simplify_polyline`)
//! - [Generating meshes from grid cells](`crate::utils::mesh_from_grid_cells`)
//!

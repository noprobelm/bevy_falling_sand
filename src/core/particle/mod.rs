...
mod tests {
    ...
    use crate::{
        core::{
            AttachedToParticleType, ChanceLifetime, ChunkCoord, ChunkIndex, ChunkLoader,
            DespawnAllParticlesSignal, DespawnParticleSignal, DespawnParticleTypeChildrenSignal,
            GridPosition, Particle, ParticleMap, ParticleType, ParticleTypeRegistry,
    ...
    use super::sync::ParticleSyncExt;
    ...
    fn hook_on_add_duplicate_particle_type_despawns_old_entity() {
        ...
        // Registry should point to the new entity.
        let registry = app.world().resource::<ParticleTypeRegistry>();
        assert_eq!(registry.get("sand"), Some(&new_entity));

        // Old entity should have been despawned.
        assert!(

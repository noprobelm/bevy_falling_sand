...
pub use crate::physics::{
    ...
    ParticleColliderRestingSettings, PromoteDynamicRigidBodyParticle, RigidBodyParticleOccupancy,
    StaticMeshUpdateInterval, StaticRigidBodyParticle, SuspendedParticle,
};

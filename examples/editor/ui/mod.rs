    ...
    egui::SidePanel::left("left_panel")
        ...
        .show(ctx, |ui| {
            ...
            ui.vertical(|ui| {
                ...
                // Top window - Particle Editor (50% of available height)
                egui::Frame::NONE
                    .fill(panel_bg)
                    .rounding(4.0)
                    ...
                    .show(ui, |ui| {
                        ...
                        // Set height to half the available space
                        ui.set_max_height(window_height);
                        
                        // Header
                        ui.horizontal(|ui| {
                            ui.label(egui::RichText::new("Particle Editor").size(14.0).strong());
                        });
                        ui.add_space(4.0);
                        ui.separator();
                        ui.add_space(4.0);
                                    ...
                                    .show(ui, |ui| {
                                        ...
                                        if flammable {
                                            ui.horizontal(|ui| {
                                                ...
                                                ui.add(egui::TextEdit::singleline(&mut duration).desired_width(40.0));
                                            });
                                            
                                            ui.horizontal(|ui| {
                                                ui.label("Tick Rate (ms):");
                                                let mut tick_rate = "100".to_string();
                                                ui.add(egui::TextEdit::singleline(&mut tick_rate).desired_width(40.0));
                                            });
